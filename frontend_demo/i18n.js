...
window.I18N = (function () {
    ...
    const DICT = {
        he: {
            ...
            "app.startResume.body": "נמצא מבחן שטרם הסתיים. להמשיך מאותה נקודה או להתחיל מבחן חדש?",
            "app.startResume.continue": "להמשיך",
            "app.startResume.newRun": "מבחן חדש",
            "app.brandAlt": "לוגו",
            "app.lang.he": "עב",
            "app.lang.en": "EN",
            ...
            "test.mic.check.continue": "המשך למבחן",
        ...
        en: {
            ...
            "app.startResume.body": "You have a test that isn’t finished yet. Continue where you left off, or start a new test?",
            "app.startResume.continue": "Continue",
            "app.startResume.newRun": "New test",
            "app.brandAlt": "Logo",
            "app.lang.he": "עב",
            "app.lang.en": "EN",
            ...
            "test.mic.check.continue": "Continue to test",
