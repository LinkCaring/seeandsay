...
window.I18N = (function () {
    ...
    const DICT = {
        he: {
            ...
            "test.sessionStartFailed.title": "לא ניתן להתחיל את המשחק השמור",
            "test.sessionStartFailed.body": "אנא חזרו למסך הבית ונסו שוב מההתחלה.",
            "test.sessionStartFailed.ctaHome": "חזרה לדף הבית",
            "test.sessionClipSaveFailed.title": "לא ניתן לשמור את ההקלטות",
            "test.sessionClipSaveFailed.body": "אנא חזרו למסך הבית ונסו שוב מההתחלה.",
            "test.sessionClipSaveFailed.ctaHome": "חזרה לדף הבית",
        ...
        en: {
            ...
            "test.sessionStartFailed.title": "Could not start saved session",
            "test.sessionStartFailed.body": "Please return to the home page and start again.",
            "test.sessionStartFailed.ctaHome": "Back to home",
            "test.sessionClipSaveFailed.title": "Could not save your recordings",
            "test.sessionClipSaveFailed.body": "Please return to the home page and start again.",
            "test.sessionClipSaveFailed.ctaHome": "Back to home",
